...
const file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDesc = "" +
	"\n" +
	"Dgithub.com/rancher/opni/pkg/apis/alerting/v1/alerting.endpoint.proto\x12\balerting\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/descriptor.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15google/api/http.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/rpc/status.proto\x1a3github.com/rancher/opni/pkg/apis/core/v1/core.proto\x1a;github.com/rancher/opni/pkg/apis/alerting/v1/alerting.proto\x1aHgithub.com/rancher/opni/pkg/apis/alerting/v1/alerting.notification.proto\"\xfd\x03\n" +
	...
	"/configure\x12q\n" +
	"\x13DeleteAlertEndpoint\x12$.alerting.DeleteAlertEndpointRequest\x1a .alerting.ConditionReferenceList\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\a/deleteB.Z,github.com/rancher/opni/pkg/apis/alerting/v1b\x06proto3"

var (
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDescOnce sync.Once
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDescData []byte
)
...
func file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDescGZIP() []byte {
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDescOnce.Do(func() {
		file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDesc), len(file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDesc)))
	})
...
var file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_goTypes = []any{
...
func file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_init() {
	...
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[0].OneofWrappers = []any{
		(*AlertEndpoint_Slack)(nil),
		(*AlertEndpoint_Email)(nil),
		(*AlertEndpoint_PagerDuty)(nil),
		(*AlertEndpoint_Webhook)(nil),
	}
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[1].OneofWrappers = []any{}
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[3].OneofWrappers = []any{}
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[18].OneofWrappers = []any{}
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[19].OneofWrappers = []any{}
	file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDesc), len(file_github_com_rancher_opni_pkg_apis_alerting_v1_alerting_endpoint_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   32,
			NumExtensions: 0,
			NumServices:   1,
